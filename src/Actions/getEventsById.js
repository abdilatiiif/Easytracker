...
export default async function getEventsById(id) {
  try {
    ...
    console.log(`Fetched data  events for beholder ID ${id}:`, data);

    return { data, error: null };
  } catch (error) {
    console.error(`Error fetching events data for beholder ID ${id}:`, error);
